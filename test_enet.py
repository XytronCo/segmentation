...
#Dataset directories
image_files = sorted([os.path.join(dataset_dir, 'tt', file) for file in os.listdir(dataset_dir + "/tt") if file.endswith('.png')])
annotation_files = sorted([os.path.join(dataset_dir, "ttannot", file) for file in os.listdir(dataset_dir + "/ttannot") if file.endswith('.png')])
